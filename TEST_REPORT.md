...
Generated: **2026-06-20 15:25 UTC**

## Summary

| | Tests | Passed | Failed | Skipped | Duration |
|---|---:|---:|---:|---:|---:|
| **backend** PASS | 399 | 399 | 0 | 0 | 33.1s |
| **frontend** PASS | 109 | 109 | 0 | 0 | 3.1s |
| **Total** PASS | **508** | **508** | **0** | **0** | **36.2s** |
...
**tests.test_audio_app_config.TestRestartServiceDedup**
  ...
  - [+] test_restart_service_returns_failed_on_error (0.02s)
...
**tests.test_audio_pipeline.TestTopologySaveValidation**
  ...
  - [+] test_non_dict_topology_returns_400 (0.10s)
  - [+] test_valid_dict_topology_is_accepted (0.12s)
...
**tests.test_auth.TestUsersCRUD**
  ...
  - [+] test_update_user_role (0.47s)
  - [+] test_cannot_delete_self (0.17s)
...
**tests.test_auth.TestDisabledUserLogin**
  ...
  - [+] test_disabled_user_cannot_login (0.46s)

**tests.test_auth.TestJwtContainsJti**

  - [+] test_jwt_has_jti_claim (0.04s)

**tests.test_auth.TestUpdateUserReturnsUpdatedState**

  - [+] test_update_returns_new_role (0.46s)
...
**tests.test_config_validation.TestConfigValidationAppconfigWhitelist**
  ...
  - [+] test_tmp_path_rejected (0.02s)
  - [+] test_var_path_rejected (0.02s)
  - [+] test_empty_appconfigfile_accepted (0.02s)
...
**tests.test_hqplayer.TestHQPlayerLiteralValidation**
  ...
  - [+] test_invalid_item_type_returns_422 (0.07s)
  - [+] test_invalid_action_returns_422 (0.07s)
  - [+] test_valid_item_type_accepted (0.11s)
...
**tests.test_hqplayer.TestHQPlayerPlayValidation**
  ...
  - [+] test_play_without_path_or_uri_returns_400 (0.20s)
  - [+] test_play_with_uri_accepted (0.21s)

**tests.test_library.TestLibrary**

  - [+] test_upnp_known_servers_route_exists (0.57s)
  - [+] test_search_route_exists (0.49s)
  - [+] test_queue_route_exists (0.47s)

**tests.test_library.TestUpnpSearchTrackId**

  - [+] test_track_id_is_res_url (0.01s)
  - [+] test_search_pre_registers_title_and_art (0.02s)
  - [+] test_search_skips_art_registration_when_absent (0.02s)
...
**tests.test_library.TestUpnpSearchQueue**
  ...
  - [+] test_unsupported_item_type_raises (0.06s)

**tests.test_library.TestUpnpQueueRouting**

  - [+] test_upnp_source_routes_to_upnp_queue (0.41s)
  - [+] test_mpd_source_still_routes_to_mpd_queue (0.48s)
...
**tests.test_license.TestDeleteLicense**
  ...
  - [+] test_delete_existing_license (0.10s)
  - [+] test_delete_wrong_password (0.03s)
  - [+] test_delete_no_license (0.04s)
...
**tests.test_license.TestCheckEndpointStatusHandling**
  ...
  - [+] test_server_5xx_returns_502 (0.04s)
  - [+] test_unexpected_response_shape_returns_502 (0.03s)

**tests.test_license.TestActivateEndpointLicContentValidation**

  - [+] test_non_json_lic_content_returns_502 (0.04s)
...
**tests.test_packages.TestOsResolverStandalone**
  ...
  - [+] test_runs_standalone_without_package_context (1.80s)
...
**tests.test_radio.TestRadio**
  ...
  - [+] test_favorites_route (0.10s)

**tests.test_radio.TestRadioEditStation**

  - [+] test_edit_station_returns_updated_station (0.08s)
  - [+] test_edit_station_404_when_not_saved (0.07s)
...
**tests.test_services.TestServiceActions**
  ...
  - [+] test_restart_service (0.10s)
  - [+] test_stop_service (0.10s)
  - [+] test_start_service (0.32s)

**tests.test_services.TestServiceNameValidation**

  - [+] test_valid_name_accepted (0.09s)
  - [+] test_semicolon_rejected (0.09s)
  - [+] test_slash_rejected (0.10s)
  - [+] test_ampersand_rejected (0.09s)
...
**tests.test_steering.TestVerifyAlsaDevice**
  ...
  - [+] test_returns_false_when_pcm_missing (0.01s)
...
**tests.test_sysinfo.TestSysinfoSmartctlSafe**
  ...
  - [+] test_smartctl_not_found_returns_none (0.02s)

**tests.test_sysinfo.TestSysinfoGrepPatternValidation**

  - [+] test_invalid_regex_returns_400 (0.16s)
  - [+] test_valid_regex_accepted (0.24s)
...
**tests.test_tidal.TestTidalRouter**
  ...
  - [+] test_get_connection_connected (0.05s)
  - [+] test_post_connection_starts_pkce (0.06s)
...
**tests.test_tidal.TestTidalRotation**
  ...
  - [+] test_fetch_manifest_404_returns_none (0.01s)
  - [+] test_refresh_401_logs_rotation_hint (0.02s)
  - [+] test_stream_endpoint_returns_503_on_rotation (0.06s)
...
**tests.test_tidal_library.TestTidalStreamProxy**
  ...
  - [+] test_stream_serves_cached_file_with_range (0.07s)
...
**tests.test_tidal_library.TestTidalDiscovery**
  ...
  - [+] test_editorial_no_pagination (0.01s)
...
**js/common.test.js**
  ...
  - [+] escapeHtml (P1 — XSS prevention) > escapes < and > as entities (0.02s)
...
**js/push-manager.test.js**
  ...
  - [+] push-manager unsubscribe (Fix P3) > calls apiDelete (not apiPost) on unsubscribe (0.67s)
  - [+] push-manager unsubscribe (Fix P3) > passes endpoint as query param in the URL (0.01s)
  - [+] push-manager unsubscribe (Fix P3) > URLSearchParams encodes the endpoint correctly (0.01s)
...
**js/version.test.js**
  ...
  - [+] version propagation (single source: /VERSION) > /VERSION is a valid semver (0.9.4) (0.01s)
...
**js/components/utils-lit.test.js**
  ...
  - [+] formatTimestamp > returns locale string for timestamps older than 24h (0.16s)
...
**js/components/organisms/ag-network-test.test.js**
  ...
  - [+] AgNetworkTest.disconnectedCallback — jitterChart destroy (Fix P2) > destroys _jitterChart when component is disconnected (1.07s)
...
**js/components/organisms/ag-user-modal.test.js**
  ...
  - [+] AgUserModal._handleSave — password trim (Fix P3) > whitespace-only password (6 spaces) is rejected (0.28s)
  - [+] AgUserModal._handleSave — password trim (Fix P3) > whitespace-only password (tabs) is rejected (0.02s)
  - [+] AgUserModal._handleSave — password trim (Fix P3) > valid password passes validation (0.02s)
  - [+] AgUserModal._handleSave — password trim (Fix P3) > password with surrounding spaces is trimmed before sending (0.01s)
  - [+] AgUserModal._handleSave — password trim (Fix P3) > short username is rejected regardless of password (0.01s)
